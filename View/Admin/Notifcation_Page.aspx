      ...
      <div class="row" dir="rtl">
        ...
        <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False" 
              ...
              <Columns>
                  ...
                  <asp:BoundField DataField="reason" HeaderText="سبب الايقاف" 
            ...
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                ...
                SelectCommand="SELECT Fuel_Shipment.shipment_code, Fuel_Shipment.region_name, Fuel_Shipment.quantity, Fuel_Shipment.plate_number, Stations.station_name, Fuel_Shipment.shipment_status, Fuel_Shipment.user_name, Fuel_Shipment.reason, Driver.driver_name, Stations.city_name FROM Stations INNER JOIN Fuel_Shipment ON Stations.station_number = Fuel_Shipment.station_number INNER JOIN Truck ON Fuel_Shipment.plate_number = Truck.plate_number INNER JOIN Driver ON Truck.license_number = Driver.license_number WHERE (Fuel_Shipment.shipment_status &lt;&gt; @shipment_status)">
                <SelectParameters>
