...
Public Class Station_Class
    ...
    Sub AddStation(ByVal station_name, ByVal region_name, ByVal city_name, ByVal registration_date, ByVal add_by)
        Dim cmd As New SqlCommand("insert into Stations (station_name,region_name,city_name,registration_date, add_by) values (@station_name,@region_name,@city_name,@registration_date,@add_by)", con)
    ...
    Function CheckStation(ByVal station_name)
        Dim cmd As New SqlCommand("select * from  Stations where station_name=@station_name", con)
        cmd.Parameters.AddWithValue("@station_name", station_name)
        Dim adp As New SqlDataAdapter(cmd)
        Dim dt As New DataTable
        adp.Fill(dt)
